...
import {EmployeeService, EmployeeStatusResponse} from "../services/employee_service";
...
export class AppComponent {
  ...
  findEmployee() {
    this.empsrv
      .findEmployee(this.employee.identityNo)
      .subscribe(employee =>
        this.employee = employee);
  }

  addEmployee() {
    this.empsrv.addEmployee(this.employee)
      .subscribe((status) => {
  ...
  updateEmployee() {
    this.empsrv.updateEmployee(this.employee)
      .subscribe((status) => {
  ...
  removeEmployee() {
    this.empsrv.removeEmployee(this.employee.identityNo)
      .subscribe((employee) => {
  ...
  deleteEmployee(emp: Employee) {
    this.empsrv.removeEmployee(emp.identityNo)
      .subscribe((employee) => {
        console.log("Employee is removed!")
        this.findAll();
        this.employee = employee;
